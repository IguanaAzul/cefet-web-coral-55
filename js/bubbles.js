...
const DURACAO_MINIMO = 3000;
const DURACAO_VARIAVEL = 5000;
...
function criaUmaBolha() {
  ...
  let duracao = DURACAO_MINIMO + Math.random() * DURACAO_VARIAVEL; // Bolhas com diferentes velocidades ficam mais bonitinhas heheh
